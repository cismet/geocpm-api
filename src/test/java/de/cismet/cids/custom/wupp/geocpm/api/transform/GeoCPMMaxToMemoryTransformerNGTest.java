...
public class GeoCPMMaxToMemoryTransformerNGTest {
    ...
    public void testTransform() throws Exception {
        ...
        assertEquals(triangles.get(0).getWaterlevel(), 4.3429579735);
        assertEquals(triangles.get(22).getWaterlevel(), 3.2579729557);
        assertEquals(triangles.get(45).getWaterlevel(), 3.3255915642);
        assertEquals(triangles.get(65).getWaterlevel(), 3.3678700924);
    }
